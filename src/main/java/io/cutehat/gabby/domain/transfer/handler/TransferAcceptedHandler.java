...
@Service
public class TransferAcceptedHandler implements ClientCommandHandler {
    private final ObjectMapper objectMapper;
    private final TransferService transferService;
    private final TransferMulticaster multicaster;

    public TransferAcceptedHandler(ObjectMapper objectMapper, TransferService transferService, TransferMulticaster multicaster) {
    ...
    public ClientCommandType type() {
        return ClientCommandType.ACCEPT_PAYLOAD_REQ;
    }
    ...
    public void handle(CommandContext ctx, ClientCommand cmd) {
        ...
        var transfer = transferService.accept(parsedCmd.transferId(), sender);
